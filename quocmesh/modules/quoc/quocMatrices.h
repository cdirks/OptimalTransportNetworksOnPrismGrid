...
/** Sparse matrix for uniform grid
 */
template <typename DataType>
...
/** A class for band matrices for use with 9-point stencils (e. g. in 2D bilinear finite element computations)
 *  \author Schwen
 */
template<typename DataType>
...
/** A class for band matrices for use with 27-point stencils (e. g. in 3D trilinear finite element computations)
 *  \author Schwen
 */
template<typename DataType>
...
/** A class for band matrices for use with 15-point stencils (e. g. in 3D affine finite element or CFE computations).
