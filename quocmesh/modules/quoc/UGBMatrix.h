...
/** template class for efficient multiplication of a band matrix
...
public:
   ...
   */
  void createNonZeroPattern ( qc::ScalarArray<unsigned char, qc::QC_2D> &img, const unsigned char zeroValue = 0, const unsigned char nonzeroValue = 255 ) {
