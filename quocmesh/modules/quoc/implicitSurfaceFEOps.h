...
/** This class computes the following weighted mass op:
...
/** This class computes the following op which is the weak formulation of the LaplaceBeltrami-operator:
 ...
 * This operator is only available in 3D!
 */
template <typename ConfiguratorType, aol::GridGlobalIndexMode IndexMode = aol::QUOC_GRID_INDEX_MODE>
