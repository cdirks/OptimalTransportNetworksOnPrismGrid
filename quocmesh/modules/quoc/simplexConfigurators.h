...
//! configurator for linear basis functions on triangles
//! \author von Deylen (july 2008)
...
public:
  ...
  inline void getLocalCoords ( const VecType &GlobalCoords,
    ...
    if ( El.getSimplexNumber() == 0 ) {
      LocalCoords [0] = 1 - localCoords[0] - localCoords[1];
      LocalCoords [1] = localCoords[0];
      LocalCoords [2] = localCoords[1];
    } else {
      LocalCoords [0] = 1 - localCoords[1];
      LocalCoords [1] = 1 - localCoords[0];
      LocalCoords [2] = localCoords[0] + localCoords[1] - 1;
    }
  }
...
//! configurator for linear basis functions on tetrahedra
//! \author von Deylen (july 2008)
template <typename _RealType, typename _QuadType, typename _InitType>
...
public:
  ...
  inline void getLocalCoords ( const VecType &GlobalCoords,
    ...
    case 0:
      LocalCoords [0] = 1 - localCoords[0] - localCoords[1];
      LocalCoords [1] = localCoords[0];
      LocalCoords [2] = localCoords[1] - localCoords[2];
      LocalCoords [3] = localCoords[2];
      break;
    case 1:
      LocalCoords [0] = localCoords[0] + localCoords[1] - localCoords[2];
      LocalCoords [1] = 1 - localCoords[0] - localCoords[1];
      LocalCoords [2] = localCoords[2] - localCoords[1];
      LocalCoords [3] = localCoords[1];
      break;
    case 2:
      LocalCoords [0] = 1 - localCoords[2];
      LocalCoords [1] = localCoords[2] - localCoords[0] - localCoords[1];
      LocalCoords [2] = localCoords[0];
      LocalCoords [3] = localCoords[1];
      break;
    case 3:
      LocalCoords [0] = 1 - localCoords[0];
      LocalCoords [1] = 1 - localCoords[1];
      LocalCoords [2] = localCoords[0] + localCoords[1] - localCoords[2] - 1;
      LocalCoords [3] = localCoords[2];
      break;
    case 4:
      LocalCoords [0] = 1 - localCoords[1];
      LocalCoords [1] = localCoords[1] - localCoords[2];
      LocalCoords [2] = 1 + localCoords[2] - localCoords[0] - localCoords[1];
      LocalCoords [3] = localCoords[0] + localCoords[1] - 1;
      break;
    case 5:
      LocalCoords [0] = localCoords[2] - localCoords[1];
      LocalCoords [1] = 1 - localCoords[2];
      LocalCoords [2] = 1 - localCoords[0];
      LocalCoords [3] = localCoords[0] + localCoords[1] - 1;
      break;
    default:
