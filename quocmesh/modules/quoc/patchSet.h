...
public:
  ...
  void extractPatchesFromArray ( const qc::MultiArray<RealType, qc::QC_2D, NumComponents> &InMArray, const bool FullOverlap ) {
    ...
    qc::extractPatchesFrom2DArray<RealType, NumComponents> ( InMArray, _patchWidth, *this, &_size, FullOverlap );
  ...
  void saveAsPNG ( const char* Filename ) const {
    qc::buildAndSavePNGFromPatches<RealType, NumComponents> ( *this, _patchWidth, _size[0], _size[1], Filename, _overlap );
  }
