...
public:
  ...
  //! returns \f$(\frac\mu2,0,\frac\lambda2I_3-(\mu+\frac\lambda2)\frac1{I_3})
  ...
  //! returns diag\f$(0,0,\frac\lambda2+(\mu+\frac\lambda2)\frac1{I_3^2})
...
public:
  ...
  inline aol::Matrix33<RealType> evaluateSecondDerivative ( const RealType I1, const RealType I2, const RealType I3,
    ...
    result *= _weight.evaluateAtQuadPoint( El, RefCoord );
    return result;
  }
