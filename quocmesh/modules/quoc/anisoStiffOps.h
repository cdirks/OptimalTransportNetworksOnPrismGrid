...
/** class for anisotropic diffusion filtering in 3D according to
...
/** class for anisotropic diffusion filtering in 3D according to Perona Malik (Level Set case)
 *
 * \f$  \partial_t \Phi - \|\nabla \Phi\|
      \mathrm{div} \left( g(\|\nabla \Phi\|) \frac{ \nabla \Phi}{\| \nabla \Phi\|} \right) =0,
      \quad g(s)=\frac{1}{1+\left(\frac{s}{\lambda}\right)^2} \f$
...
/***********************************************
 * class for anisotropic diffusion filtering for 2d and 3d and arbitrary base functions
 * \author Droske
 */
template <typename ConfiguratorType>
...
/***********************************************
 * class for anisotropic diffusion filtering in 2D
 * \author Droske
 */
template <typename ConfiguratorType>
...
/** class for anisotropic diffusion filtering in 3D (NOT Level Set case)
 *
 * \f$  \partial_t \Phi -
      \mathrm{div} \left( A(\nabla \Phi) \nabla \Phi \right) =0,
