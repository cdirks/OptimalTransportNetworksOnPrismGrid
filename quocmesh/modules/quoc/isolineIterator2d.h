...
public:
  ...
  IsoLineIterator2d ( qc::IsoLineIterator2d<ConfiguratorType> &It )
      : _config ( It._grid ), _grid ( It._grid ), _func ( It._func ), _isoValue ( It._isoValue ), _reached_end ( It._reached_end ) {
    _elit = It._elit;
