...
//! operator from willmore flow with p-regularization.
...
/** ********************************************************************************************
// qc::WillmoreProjectionStiffOp
// implementation of \f[ \int_{\Omega} \frac{P[\nabla \Phi]}{|\nabla \Phi|} \nabla \psi_i \nabla \psi_j \, dx \f],
// with \f$ P[\nabla \Phi] = Id - \frac{\nabla \Phi}{|\nabla \Phi|} \otimes \frac{\nabla \Phi}{|\nabla \Phi|} \f$.
// Just for the ISOTROPIC willmore flow!
// ******************************************************************************************** */
...
/** ********************************************************************************************
// qc::WillmoreStiffImpOp
// implementation of \f[ \int_{\Omega} ( \gamma_{zz}(\nabla \Phi) \nabla \psi_i \nabla \psi_j \, dx \f],
// For the ANISOTROPIC willmore flow!
// ******************************************************************************************** */
...
/**
 * implementation of \f[ \int_{\Omega} \frac12 \frac{W^2}{\| \nabla \phi \|^3_{\epsilon} } \nabla \psi_i \nabla \psi_j \, dx \f]
 */
template <typename ConfiguratorType>
