...
/**
 * Class to validate first derivatives or derivatives of vector valued functions.
 *
 * Meant to supersede all testFirstDerivative* functions.
 *
 * \author Berkels
 */
...
/**
 * Class to validate second derivatives or derivatives of vector valued functions.
 * Input is a vector-valued fct \f$ F \f$, maybe the gradient of a scalar
 * function \f$ \nabla E \f$, and \f$ DF = D^2 E \f$.
 *
 * Meant to supersede all testSecondDerivative* functions.
 *
