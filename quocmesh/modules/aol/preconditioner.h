...
/** SSOR preconditioning which is naively implemented by performing
...
/** A class for preconditioning sparse matrices by ILU(0).
 *  ATTN: The preconditioner must compute a decomposition (in the constructor), so it uses a copy of the matrix
...
/** Block-SSOR preconditioning which is naively implemented by
...
/** Block variant of the SSOR preconditioner.
