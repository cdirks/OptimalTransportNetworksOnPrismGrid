...
protected:
  ...
  mutable auto_ptr<DerivativeType> _NLEQ_ERR_delta_x_bar;
...
/**
 * This class implements a quasi-Newton method (the DFP-method) for minimizing a scalar function.
...
/**
 * This class implements a quasi-Newton method with BFGS-Update of the matrix for minimizing a scalar function.
 * It has to be provided the scalar function and its derivative.
 *
 * \author Teusner
 */
