...
private:
  ...
  /** Generic l2 energy descent with conjugate directions,
...
//! Generic energy descent using an arbitrary metric tensor with conjugate directions, projecting back into some allowed set in each step
//! uses difference quotients by default
template <class DataType, class IndexType>
...
//! Gradient descent (no conjugate directions!) for an energy e + d, where e is smooth and d has some kinks.
