...
/*!
 * Base class for QR-decomposition transforms based on Given-Rotations.
...
//! QR decomposition for a upper triangular matrix
...
/*!
 * QR-decomposition based on the modified Gram-Schmidt (MGS) process described in
