...
/**
 * Computes \f$ - \int H'(\phi(x)) f(x) \varphi_j dx \f$, where arg[0]=f, LevelsetFunction=phi and HeavisideFunction=H.
 *
 * \author Berkels
 */
template <typename ConfiguratorType, typename HeavisideFunctionType>
...
/**
 * \brief Heaviside function replacement to convert the Chan Vese model to the one of Chan Esedoglu Nikolova with exact penalty.
 *
 * \author Berkels
 */
