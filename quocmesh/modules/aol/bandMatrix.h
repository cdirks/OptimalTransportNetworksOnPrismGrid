...
namespace aol {
/** A class for general band matrices.
...
/** A class for band matrices that have adjacent bands, e. g. centered at the main diagonal.
 *  \author Schwen
 */
...
/** A class for band matrices with two lower, main and one upper diagonals.
 *  \author Schwen
 */
template<typename DataType>
...
/** A class for band matrices with one lower, main and two upper diagonals.
 *  \author Schwen
 */
template<typename DataType>
