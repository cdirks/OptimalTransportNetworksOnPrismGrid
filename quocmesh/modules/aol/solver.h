...
/**
 * Class for approximation of inverse for cg solver.
 * \ingroup solver
 * \author Droske
 */
template < typename VectorType, typename OpType = Op<VectorType> >
...
/** Jacobi solver for operators that support makeRowEntries
 *  \ingroup solver
...
/** Gauss-Seidel solver for operators that support makeRowEntries. Default behavior is symmetric Gauss-Seidel due to historical reasons.
 *  \ingroup solver
 *  \author Schwen (Droske)
 */
template < typename VectorType, typename OpType >
...
/** Simple interface for using direct inversion methods of matrix classes as solvers
 *  \ingroup solver
 *  \author Geihe
 */
