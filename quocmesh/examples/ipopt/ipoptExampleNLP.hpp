...
#ifdef USE_EXTERNAL_IPOPT
#include "ipoptIncludes.h"
#else
#error "Ipopt required!"
#endif
...
public:
  ...
  /** Method for intermediate callbacks */
  virtual bool intermediate_callback(AlgorithmMode mode, Index iter, Number obj_value, Number inf_pr, Number inf_du, Number mu, Number d_norm,
                                     Number regularization_size, Number alpha_du, Number alpha_pr, Index ls_trials, const IpoptData* ip_data,
