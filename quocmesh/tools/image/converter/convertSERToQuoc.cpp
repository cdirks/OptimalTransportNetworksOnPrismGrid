...
int main ( int argc, char **argv ) {
  ...
  try {
    ...
    switch ( dataTypeID ) {
      // 1D data
      case 0x4120:
        throw aol::UnimplementedCodeException ( "Reading 1D data from SER files is not implemented yet.", __FILE__, __LINE__ );
        break;
      ...
      case 0x4122:
        {
          for ( int i = 0; i < validNumberElements; ++i ) {
            ...
            a.loadRaw ( in, getSerSaveType ( dataType ), numX, numY );
