...
//! @file
//!
//! @brief Load two scalar functions with 1d domain and one scalar function with 2d domain into GRAPE as two different objects.
//!
//! Usage: \code ./scalarTwo1dOne2d data1d data1d data2d \endcode
//!
//! GRAPE is started with two 1d triang object and one 2d mesh object each having one scalar function.
//!
//! @author Franken
...
int main (int argc, char** argv)
{
  try {
    if (argc != 4) {
      cerr << "usage: " << argv [0] << " data1d data1d data2d" << endl;
      return 23;
    }
    ...
    ASSIGN (scene1d2->next_scene, scene2d);
