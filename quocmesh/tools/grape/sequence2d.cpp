...
//! @file
//!
//! @brief Load a sequence of scalar functions with a 2d domain.
//!
//! Usage: \code ./sequence2d step0 [step1 ...] \endcode
//!
//! The time steps need to be defined on the same grid, and are interpreted as values of one scalar functions at times 0, 1, 2, ...
//! GRAPE is started with one time dependent 2d mesh object having one scalar function.
//!
//! @author Lenz
...
int main (int argc, char** argv)
{
  try {
    ...
    GENMESH2D* mesh = quocmesh_convert_to_gmesh2d (&data, "scalar");
