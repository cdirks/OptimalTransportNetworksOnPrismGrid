...
//! \author Heeren
//! Computes geodesic extrapolation (shooting) via discrete version of exponential map
//! Note: Control via parameter file possible, e.g. use your own modification of parShootGeodesic.txt!
...
int main(int argc, char **argv)
{
  try {        
    ...
    if ( argc != 2 ) { 
      ...
      cerr << "Usage: ./shootGeodesic <parameterFile>" << endl;
      return EXIT_FAILURE;
    }
    ...
    ShootingOp<TriMeshCenterQuadConf, MembraneDeformationType, BendingDeformationType>( pparser ).execute( ); 
