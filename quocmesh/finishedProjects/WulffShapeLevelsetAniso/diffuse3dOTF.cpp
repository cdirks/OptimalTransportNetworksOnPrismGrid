...
int main( int argc, char **argv ) {
  ...
  try {
    ...
    aol::LinCombOp< aol::Vector<double> > DiffuseOp;

    DiffuseOp.appendReference( L, tau );
    DiffuseOp.appendReference( M );
...
//     cerr<<" nach precond. ";
//     aol::PCGInverse<aol::Vector<double> > solver( DiffuseOp, precond, 1e-16, 1000 );
    aol::CGInverse<aol::Vector<double> > solver( DiffuseOp, 1e-16, 1000 );
    ...
    // Schleife mit der eigentlichen Gl�ttung
...
//     addScalarData( mesh, &img, "gegl�ttete Daten" );
