...
/* ********************************************************
 * Datei: convertPgmstoScalarArray3d.cpp
 * Autor: Oliver Nemitz
 * Programm lädt eine Liste von pgm-Bildern ein
 * und speichert entweder alles oder einen Ausschnitt
 * in einem ScalarArray, dessen Grösse vorgegeben
 * werden kann!
 * ******************************************************** */
...
void copyImgToScalarArray( qc::ScalarArray<RealType, qc::QC_3D>* data, qc::ScalarArray<RealType, qc::QC_2D> &image, int z,
                      bool doThreshold, double threshold, bool saveOnly01,
                      ...
                      int DestOffsetX,   int DestOffsetY,  int DestOffsetZ )
{
  ...
  double value = 1;            // this value has to be stored
...
//     }
    ...
    double threshold  = parser.getDouble("threshold");
