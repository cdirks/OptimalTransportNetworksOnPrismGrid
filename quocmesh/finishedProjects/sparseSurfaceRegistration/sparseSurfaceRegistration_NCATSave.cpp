...
try 
{
	...
	//// In order for DEReg to be the derivative of TwoTimesEReg the latter has to be multiplied by 0.5.
	//// Do this in appendReference when adding TwoTimesEReg to a aol::LinCombOp.
