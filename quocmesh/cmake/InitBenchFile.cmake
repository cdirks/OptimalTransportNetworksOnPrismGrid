...
FILE ( APPEND ${CMAKE_BINARY_DIR}/benchmark-results-${QUOC_HOSTNAME}.txt
  ...
  "Compilation flags      : ${CMAKE_CXX_FLAGS}\n"
  "Release mode flags     : ${CMAKE_CXX_FLAGS_RELEASE}\n"
  "Linker flags           : ${CMAKE_EXE_LINKER_FLAGS} ${CMAKE_MODULE_LINKER_FLAGS} ${CMAKE_SHARED_LINKER_FLAGS}\n"
  "Release linker flags   : ${CMAKE_EXE_LINKER_FLAGS_RELEASE} ${CMAKE_MODULE_LINKER_FLAGS_RELEASE} ${CMAKE_SHARED_LINKER_FLAGS_RELEASE}\n"
  "\n"
